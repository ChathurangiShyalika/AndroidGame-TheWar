package com.chathu.androidgame_thewar;
...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public void drawText(Canvas canvas)
    {
        ...
        canvas.drawText("SCORE: " + (player.getScore()),WIDTH - 215, HEIGHT - 10, paint);
        canvas.drawText("BEST: " + best, WIDTH - 215, HEIGHT - 450, paint);
